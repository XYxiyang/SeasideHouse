...
void InitCubeMap();
void DrawCubeMap(glm::vec3 insideCameraPos, glm::mat4 projection, glm::mat4 view, Skybox& skybox);
...
int main()
{
    ...
    InitCubeMap();
    //make
    DrawCubeMap(glm::vec3(0,0,0), projection, view, skybox);
    
    IBLMAPS cubeIBLmaps = GetIBLMAPS(cubeBuffer, window);
